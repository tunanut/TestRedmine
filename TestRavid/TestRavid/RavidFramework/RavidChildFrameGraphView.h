...
// RavidChildFrameGraphView.h : CRavidChildFrameGraphView 클래스의 인터페이스
//
...
namespace Ravid
{
	namespace Framework
	{
		class AFX_EXT_CLASS CRavidChildFrameGraphView : public CRavidChildFrameImageView
		{
			RavidUseDynamicCreation();

			DECLARE_DYNCREATE(CRavidChildFrameGraphView)
		public:
			CRavidChildFrameGraphView();
			virtual ~CRavidChildFrameGraphView(); 
		...
		public:
			...
			virtual bool VisibleToolBarButton(_In_ ERavidToolBarEventGraphView eEvent, _In_ bool bVisible);
